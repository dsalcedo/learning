...
Route::group(['namespace'=>'Webapp'], function (){
    ...
    Route::get('redeem', 'RedeemController@index')->name('webapp.redeem');
    Route::post('redeem', 'RedeemController@store')->name('redeem.store');
    ...
    Route::group(['prefix' => 'suscripciones'], function (){
        Route::get('/', 'SuscripcionesController@index')->name('webapp.suscripcion');
    ...
    Route::group(['prefix' => 'mi'], function (){
        Route::get('suscripcion', 'MiSuscripcionController@index')->name('mi.suscripcion');
    });
});
